...
[![▶️ Voir la démonstration du dashboard](https://img.shields.io/badge/▶%20Voir%20la%20démo-Power%20BI%20Dashboard-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://cap.link/hc6dx840snyv79y)

> 👆 Clique sur le bouton ci-dessus pour voir la vidéo de présentation du dashboard Power BI.
...
## 📊 Analyse de la rentabilité par sous-catégorie – Segment Consumer
...
## 📊 Analyse de la rentabilité par sous-catégorie – Segment Corporate

![Rentabilité Corporate](rentabilite-sub-category-corporate.png)

La rentabilité du segment Corporate est globalement positive, avec une majorité de sous-catégories profitables.  

Des sous-catégories comme **Copiers, Paper, Envelopes et Labels** se distinguent par des marges élevées, constituant les principaux moteurs de profit.  

Cependant, **Tables** reste déficitaire, indiquant une perte malgré un niveau de chiffre d’affaires significatif.  

### 🎯 Conclusion

La performance du segment Corporate est globalement saine, mais certaines sous-catégories continuent de peser sur la rentabilité et nécessitent une optimisation ciblée.

## 📊 Analyse de la rentabilité par sous-catégorie – Segment Home Office

![Rentabilité Home Office](rentabilite-sub-category-home-office.png)

Le segment Home Office présente une rentabilité globalement positive, avec plusieurs sous-catégories performantes.  

Des sous-catégories comme **Paper, Copiers, Envelopes et Labels** affichent des marges élevées, constituant les principaux contributeurs au profit.  

Cependant, **Tables** reste déficitaire, avec une marge négative, ce qui indique une perte malgré un volume de ventes.  
